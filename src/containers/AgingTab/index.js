...
class AgingTabScreen extends PureComponent {
    ...
    exportFile() {
        ...
        const file = DDP + "customer_aging" + Math.floor(date.getTime()
                    ...
                    this.state.show_list.length > 0 ?
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                numberOfLines={2}
                            >{show_list.reduce((prev, next) => prev + parseInt(next.day0_30), 0)}</Text>
                            <Text style={{
                                ...
                                numberOfLines={2}
                            >{show_list.reduce((prev, next) => prev + parseInt(next.day31_60), 0)}</Text>
                            <Text style={{
                                ...
                                numberOfLines={2}
                            >{show_list.reduce((prev, next) => prev + parseInt(next.day61_90), 0)}</Text>
                            <Text style={{
                                ...
                                numberOfLines={2}
                            >{show_list.reduce((prev, next) => prev + parseInt(next.day91_120), 0)}</Text>
                            <Text style={{
                                ...
                                numberOfLines={2}
                            >{show_list.reduce((prev, next) => prev + parseInt(next.day121_above), 0)}</Text>
    ...
    render() {
        const { ch_customer_name, ch_ason, ch_all,
            display_name, filter_type ,focus} = this.state;
