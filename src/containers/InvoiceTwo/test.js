              ...
              <View
                ...
                <View style={styles.userInput}>
                  <RNPickerSelect
                    ...
                    value={this.state.add_item_type}
                  />
                </View>
                ...
                <View style={styles.userInput}>
                  <TextInput
                    ...
                    onChangeText={add_name => this.setState({add_name})}
                ...
                <View style={styles.userInput}>
                  <RNPickerSelect
                    ...
                    onValueChange={add_unit => {
                      this.setState({add_unit});
                ...
                <View style={styles.userInput}>
                  <TextInput
                    ...
                    placeholderTextColor="grey"
                    underlineColorAndroid="transparent"
                    onChangeText={add_rate => this.setState({add_rate})}
                    value={this.state.add_rate}
                  />
                </View>

                <Text style={styles.txt_h}>
                  {this.state.item_type == 'Goods' ? 'HSN Code' : 'SAC Code'}
                </Text>
                <View style={styles.userInput}>
                  <TextInput
                    style={styles.input}
                    ...
                    placeholderTextColor="grey"
                    underlineColorAndroid="transparent"
                    onChangeText={add_hsn_sac_code =>
                      this.setState({add_hsn_sac_code})
                    }
                    value={this.state.add_hsn_sac_code}
                  />
                </View>
                ...
                <View style={styles.userInput}>
                  <RNPickerSelect
                    ...
                    onValueChange={value => {
                      this.setState({add_gst: value});
                    }}
                    value={this.state.add_gst}
                  />
                </View>
                ...
                <View style={styles.userInputTC}>
                  <TextInput
                    ...
                    placeholderTextColor="grey"
                    underlineColorAndroid="transparent"
                    onChangeText={add_des => this.setState({add_des})}
                    value={this.state.add_des}
                    maxLength={150}
                  />
                </View>
