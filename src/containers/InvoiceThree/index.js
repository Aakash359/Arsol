    ...
    saveEstimate(){
        ...
        if (!network.isConnected) {
            ...
            this.setState({ loading: true }, () => {
              ...
              .then(responseJson => {
                console.log('NewInvoice_api', responseJson);
...
<Text style={styles.txt_h}>Subject</Text>
  ...
  render() {
    return (
      ...
      <View style={{marginLeft:scale(80),marginTop:scale(15),
        ...
        <Text style={{
          ...
          color: "black",
          fontWeight: 'bold'
        }}>{this.props.edit_id ? "Edit Invoice" : "New Invoice"}</Text>
