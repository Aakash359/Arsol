...
class EstimateListScreen extends PureComponent {
  ...
  //           // this.GetItem(rowData.item.es_id)
  ...
  _renderListItem(rowData) {
    ...
    return (
      ...
      >
        ...
        <Text style={styles.txt}
          numberOfLines={1}
        >  Estimate Type: {rowData.item.es_type}</Text>

        <Text style={styles.txt}
          numberOfLines={1}
        >  Contact Display Name: {rowData.item.es_dis_name}</Text>
        <Text style={styles.txt}
          numberOfLines={1}
        >  Estimate Date: {rowData.item.es_date}</Text>
        <Text style={styles.txt}
          numberOfLines={1}
