...
class CustomerPayOneScreen extends PureComponent {
   ...
   borderColor: 'grey',
    ...
    _bankRender(){
        const { bank_value, payment_mode_value, pay_list, bank_list,utr_chq } = this.state
        return(
  ...
  savePress() {
    ...
    style={{ width: scale(25), 
      ...
      renderSlidingUpPanel() {
        const {item_list ,advCheck,adv_account} = this.state;
    ...
    render() {
        const { company_list, item_list } = this.state
        ...
        return (
            <View style={{
                ...
                <NavigationBar
                    ...
                    SearchButtonIcon={Images.search}
