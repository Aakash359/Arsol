        ...
        return (
            ...
            >
                ...
                <Text style={styles.txt} numberOfLines={1}>
                    Credit Note Number:{rowData.item.cn_number}
                </Text>
                ...
                <Text style={styles.txt} numberOfLines={1}>
                    Invoice Type:{rowData.item.in_type}
                </Text>

                <Text style={styles.txt} numberOfLines={1}>
                    Contact Display Name:{rowData.item.customer_name}
                </Text>
                ...
                <View style={{
                    ...
                    <Text style={styles.txt} numberOfLines={1}>
                        Invoice Date:{rowData.item.in_date}
                    </Text>

                    <Text style={styles.txt} numberOfLines={1}>
                        Total Amount:{rowData.item.total_amount}
                    </Text>
